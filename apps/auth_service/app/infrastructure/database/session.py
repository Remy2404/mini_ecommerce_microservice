"""Async SQLAlchemy session helpers for Auth Service."""
...
from apps.auth_service.app.infrastructure.database.engine import get_async_engine


class Base(DeclarativeBase):
    """Shared declarative base for Auth Service-owned models."""
