...
from apps.payment_service.app.infrastructure.database.engine import get_async_engine


class Base(DeclarativeBase):
    """Shared declarative base for Payment Service-owned SQLAlchemy models."""
