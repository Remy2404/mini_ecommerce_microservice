...
from apps.product_service.app.schemas import ApiResponse, CreateProductRequest, ProductResponse
...
async def create_product_endpoint(
    ...
    product = await routes_module.create_product(request)
...
async def list_products_endpoint() -> ApiResponse[list[ProductResponse]]:
    products = await routes_module.find_products()
...
async def get_product_endpoint(
    ...
    product = await routes_module.find_product(product_id)
